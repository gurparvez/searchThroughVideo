...
const Login = () => {
    ...
    return (
        <section className={`relative bg-gray-50 dark:bg-gray-900 ${isLoading ? 'pointer-events-none':'pointer-events-auto'}`}>
            {
                isLoading &&
                <Spinner  />
            }
            <div className='flex flex-col items-center justify-center py-8 mx-auto md:h-screen lg:py-0'>
                ...
                <div className='w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700'>
                    <div className='p-6 space-y-4 md:space-y-6 sm:p-8'>
                        ...
                        <form onSubmit={handleSubmit(submit)} className='space-y-4 md:space-y-6'>
                            <Input
                                label='Username'
                                error={error}
                                readonly={isLoading}
                            ...
                            <Button
                                ...
                                bgDark={isLoading ? 'bg-blue-800' : 'bg-blue-600'}
                                classname='w-full'
                            />
